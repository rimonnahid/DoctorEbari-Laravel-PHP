...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h3 class="font-weight-bold mt-3">Edit District Form <a href="{{ route('list.district') }}" class="btn btn-sm btn-primary float-right">All District</a></h3>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" class="form-control @error('district_name') is-invalid @enderror" name="district_name" value="{{ $district->district_name }}" placeholder="enter Division name" required>
                        @error('district_name')
