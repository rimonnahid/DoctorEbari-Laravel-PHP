...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h3 class="font-weight-bold mt-3">Division List <a href="{{ route('create.division') }}" class="btn btn-sm btn-primary float-right">New Division</a></h3>
    </div>
</div>
            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach($divisions as $division)
                    <tr class="gradeX">
                        ...
                        <td class="center">
                        	<a href="{{ route('edit.division',$division->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                        	<a href="{{ route('delete.division',$division->id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
