...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-12">
        <h3 class="font-weight-bold mt-3">New Upzila Form <a href="{{ route('list.upzila') }}" class="btn btn-sm btn-primary float-right">All Upzila</a></h3>
    </div>
</div>
<div class="wrapper wrapper-content">
    <div class="ibox-content">
        <form action="{{ route('store.upzila') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="text" class="form-control @error('upzila_name') is-invalid @enderror" name="upzila_name" value="{{ old('upzila_name') }}" placeholder="enter Upzila name" required>
                        @error('upzila_name')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
