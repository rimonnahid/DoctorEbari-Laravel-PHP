            ...
            <table class="table table-striped table-bordered table-hover dataTables-example" >
                ...
                @foreach($categories as $category)
                    <tr class="gradeX">
                        ...
                        <td class="center">
                        	<a href="{{ route('edit.category',$category->cat_id) }}" class="btn btn-primary btn-sm"><i class="fa fa-pencil"></i></a>
                            @if($category->status == 1)
                                <a href="{{ route('deactive.category',$category->cat_id) }}" class="btn btn-sm btn-warning"><i class="fa fa-thumbs-down"></i></a>
                            @else
                                <a href="{{ route('active.category',$category->cat_id) }}" class="btn btn-sm btn-success"><i class="fa fa-thumbs-up"></i></a>
                            @endif
                        	<a href="{{ route('delete.category',$category->cat_id) }}" class="btn btn-danger btn-sm" id="delete"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
